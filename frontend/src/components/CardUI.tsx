...
function CardUI()
{
    ...
    async function addCard(e:any) : Promise<void>
    {
        ...
        try
        {
            const response = await fetch('https://card.christopherjparrett.xyz/api/addcard',
    ...
    async function searchCard(e:any) : Promise<void>
    {
        ...
        try
        {
            const response = await fetch('https://card.christopherjparrett.xyz/api/searchcards',
            {method:'POST',body:js,headers:{'Content-Type': 'application/json'}});
